<?php
function homepage_team_section( $wp_customize ){
    ...
    $wp_customize->add_section( 'team_section' , array(
		...
		$wp_customize->selective_refresh->add_partial( 'business_option[team_section_title]', array(
			'selector' => '#team .section-title',
			'settings' => 'business_option[team_section_title]',
		) );
		...
		$wp_customize->selective_refresh->add_partial( 'business_option[team_section_description]', array(
			'selector' => '#team .section-desc',
			'settings' => 'business_option[team_section_description]',
		) );
...
add_action( 'customize_register', 'homepage_team_section' );