 ...
 * @since 1.0.0
 */
class Construction_Base_Footer_Widgets {
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'construction_base';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'construction-base' ), $i ),
...
// Initialize.
$construction_base_footer_widgets = new Construction_Base_Footer_Widgets();
